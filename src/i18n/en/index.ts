export default {
  ...
  notice: {
    ...
    contents: [
      ...
      { type: 'image', value: '/images/notice/20240518/greater_affix.webp' },
      { type: 'list', value: 'You can now specify greater affixes when registering or editing an item.', class: 'text-weight-bold text-orange text-subtitle2' },
      { type: 'space' },
