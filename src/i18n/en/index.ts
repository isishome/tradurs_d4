export default {
  ...
  notice: {
    title: 'Update Notice',
    top: 'Hello. This is Tradurs. Here\'s what\'s been updated today',
    contents: [
      { type: 'head', value: '◆ Updates' },
      { type: 'list', value: 'Summoning materials and materials sets have been deleted and added.', class: 'text-weight-bold text-orange text-subtitle2' },
      { type: 'head', value: '◆ Deleted materials' },
      { type: 'list', value: 'Set of Malpas materials' },
      { type: 'list', value: 'Set of Zir materials' },
      { type: 'list', value: 'Set of Grigoire materials' },
      { type: 'head', value: '◆ Added materials' },
      { type: 'list', value: 'Stygian Stone' },
      { type: 'list', value: 'Sandscorched Shackles' },
      { type: 'list', value: 'Pincushioned Doll' },
      { type: 'list', value: 'Set of Andariel materials' },
      { type: 'list', value: 'Set of torment Grigoire, Varshan, Zir, Duriel, Andariel materials' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240524/materials.webp' },
      { type: 'space' }
    ],
    bottom: 'Thank you',
    close: 'Do not open for 24 hours'
