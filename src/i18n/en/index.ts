export default {
  ...
  notice: {
    ...
    contents: [
      ...
      { type: 'list', value: 'You can now specify greater affixes when registering or editing an item.', class: 'text-weight-bold text-orange text-h6' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/add.webp' },
      { type: 'list', value: 'Click the icon to the left of the affix to specify it as a greater affix,' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/greater.webp' },
      { type: 'list', value: 'The icon will change to an greater affix icon.\nClick once more to return to the normal affix.' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/mark.webp' },
      { type: 'list', value: 'Greater affix marks are added to the top left of the item box and affix icons.' },
      { type: 'space' },
