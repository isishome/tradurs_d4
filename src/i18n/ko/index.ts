export default {
  ...
  notice: {
    title: '아이템 거래 관련 공지',
    top: '안녕하세요. Tradurs입니다.\n\n거래 관련 변경, 숙지 신규 추가된 사항 안내드립니다.',
    contents: '\n◆ 변경되는 사항\n\t제안이 거절된 경우 재 요청 불가\n\t➜ 제안이 거절된 경우 재 요청 가능\n\n◆ 숙지 사항\n\t24시간 이내 완료 처리하지 않은 거래 진행 중인 아이템의 등록자나 제안자의 매너 온도가 고정 1도 하락합니다. (거래가 무산 된 경우에도 꼭 완료 처리 필요)\n\n◆ 추가 사항\n\t지난주 어워즈 수상자의 아이템이 랜덤하게 최 상단에 1개 표시됩니다.\n\n',
    bottom: '다른 변경사항이 있을 경우 다시 공지를 통해 안내해 드리도록 하겠습니다.\n\n감사합니다.',
    close: '24시간 동안 열지 않기'
  },
  message: {
    page: '페이지 {page}'
