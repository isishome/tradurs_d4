export default {
  ...
  maintenance: {
    ...
    top: '안녕하세요. Tradurs입니다.\n\n새로운 시즌이 시작되는 2023년 7월 21일 02:00 이전에 정기점검 안내드립니다.',
    contents: '◆ 점검 일자\n\t2023년 7월 21일(금) 01:00 ~ 점검 완료 시\n◆ 변동 사항\n\t이전 시즌 데이터가 비시즌(스탠)으로 이동됩니다.\n\t기본 필터의 시즌 항목이 활성화 됩니다.\n\t아이템 등록 필드 중 시즌 항목이 활성화 됩니다. \n\t잘못 입력되거나 사용하지 않는 옵션 항목이 삭제됩니다.',
    bottom: '서버가 정상화되면 다시 공지를 통해 안내해 드리도록 하겠습니다.\n\n감사합니다.',
    close: '24시간 동안 열지 않기'
  },
  notice: {
    title: '변경 및 업데이트 내역, 유의사항 공지',
    top: '안녕하세요. 트레이더스입니다.\n\n변경 및 업데이트 내역과 유의사항 안내드립니다.',
    changes: "◆ 변경\n· \'제안받기\' 기능 : 매너 온도 1도 이상 → 배틀태그 인증 사용자\n· 주간 어워즈 대상 : 일정 매너 온도 이상 → 일정 매너 온도 이상 + 배틀태그 인증 사용자\n· 금화 아이콘 이미지 변경\n· 최소 / 최대 금화 판매, 제안 금액 : 100,000 / 9,999,999,999,999 → 100,000 / 99,999,900,000\n· 금화 최소 단위 : 1 → 100,000\n",
    updates: "◆ 업데이트\n· 배틀넷 로그인 기능이 추가되었습니다.\n· 배틀 태그 인증 기능이 추가되었습니다.\n· 배틀 태그 인증 기능이 추가됨에 따라 배틀 태그 수정 제한은 삭제되었습니다.\n· 로그인 상태에서 사용자 정보 툴팁에 배틀 태그 인증 여부가 표시됩니다.",
    cautions: "◆ 유의 사항\n· 현금 거래를 유도하는 행위 금지\n· 임의 배틀 태그 노출 금지",
    bottom: '감사합니다.',
    close: '24시간 동안 열지 않기'
  },
