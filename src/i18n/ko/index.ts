export default {
  ...
  notice: {
    title: '업데이트 안내',
    top: '안녕하세요. 트레이더스입니다. 금일 업데이트 된 사항 안내드립니다.',
    contents: [
      { type: 'head', value: '◆ 업데이트 사항' },
      { type: 'list', value: '소환 재료 및 재료 셋이 삭제, 추가되었습니다.', class: 'text-weight-bold text-orange text-subtitle2' },
      { type: 'head', value: '◆ 삭제된 재료' },
      { type: 'list', value: '말파스 재료 셋' },
      { type: 'list', value: '지르 재료 셋' },
      { type: 'list', value: '그리구아르 재료 셋' },
      { type: 'head', value: '◆ 추가된 재료' },
