export default {
  ...
  notice: {
    ...
    contents: [
      ...
      { type: 'list', value: '이제 아이템 등록 또는 수정 시 상급 속성을 지정할 수 있습니다.', class: 'text-weight-bold text-orange text-subtitle2' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/add.webp' },
      { type: 'list', value: '상급 속성으로 지정할 옵션 항목 좌측에 있는 아이콘을 클릭하면,' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/greater.webp' },
      { type: 'list', value: '아이콘이 상급 속성 아이콘으로 변경됩니다.\n한번 더 클릭하면 다시 일반 속성으로 돌아옵니다.' },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20240518/mark.webp' },
      { type: 'list', value: '아이템 박스 좌측 상단 및 옵션 항목에 상급 속성 표식이 추가됩니다.' },
      { type: 'space' },
      { type: 'separator' },
      { type: 'space' },
