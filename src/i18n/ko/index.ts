export default {
  ...
  notice: {
    ...
    contents: [
      ...
      { type: 'list', value: '이제 아이템 상태 필터가 기본적으로 \'판매 중\'으로 설정됩니다.', class: 'text-weight-bold text-negative text-subtitle2' },
      ...
      { type: 'list', value: '이제 아이템 상태 필터 값이 기본적으로 \'판매 중\'으로 설정되며, \'전체\' 필터 옵션은 삭제됩니다.' },
      ...
      { type: 'head', value: '◆ 삭제된 재료 셋' },
      { type: 'list', value: '말파스 재료 셋' },
      { type: 'list', value: '지르 재료 셋' },
      { type: 'list', value: '그리구아르 재료 셋' },
      { type: 'head', value: '◆ 추가된 재료 및 재료 셋' },
      { type: 'list', value: '칠흑의 돌' },
      { type: 'list', value: '모래그을음의 굴레' },
      { type: 'list', value: '바늘꽂이 인형' },
      { type: 'list', value: '안다리엘 재료 셋' },
      { type: 'list', value: '고행 그리구아르, 바르샨, 지르, 두리엘, 안다리엘 재료 셋' },
      { type: 'space' },
