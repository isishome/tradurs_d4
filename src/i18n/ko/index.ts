export default {
  ...
  notice: {
    title: '업데이트 및 주의사항',
    top: '안녕하세요. 트레이더스입니다.\n\n업데이트 및 주의사항 안내드립니다.',
    changes: "◆ 변경\n· 아이템 옵션 사용자 정의 기능 → 아이템 옵션 사용자 요청 기능",
    updates: "◆ 업데이트 사항\n· 사용자 차단 / 차단 해제 기능 추가\n\t→ 이제 사용자 정보 툴팁에서 사용자 차단 / 차단 해제가 가능합니다.\n\t→ 사용자 차단은 배틀 태그가 노출된 상태일 때 가능합니다.\n\t→ 사용자 차단 해제는 차단 48시간 이후 배틀 태그가 노출된 상태일 때 가능합니다.\n\t→ 차단된 사용자는 정보 아이콘(🛈) 대신에 차단 아이콘(🛇) 이 표시됩니다.",
    cautions: "◆ 주의사항\n· 부정적인 방법을 통한 매너 온도 상승, 현금 거래 유도 또는 배틀 태그 노출 등의 행위를 할 경우 경중에 따라 일정 기간 서비스가 이용 중지되거나 계정 정지까지 될 수 있으니 이점 유의하시기 바랍니다.",
    bottom: '감사합니다.',
    close: '24시간 동안 열지 않기'
  },
  adblock: {
