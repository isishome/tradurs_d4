export default {
  ...
  notice: {
    title: '2026년 7월 26일 업데이트',
    top: '안녕하세요, Tradurs입니다.\n아이템 상세 페이지의 관련 물품 기능이 새롭게 추가되었습니다.',
    contents: [
      { type: 'head', value: '관련 물품 기능' },
      {
        type: 'list',
        value:
          '아이템 상세 페이지에서 같은 판매자가 등록한 다른 판매 중 물품을 확인할 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '현재 장비와 같은 종류이면서 공통 속성이 3개 이상인 유사 아이템을 함께 확인할 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '판매자의 다른 물품과 유사 아이템은 중복되지 않도록 구분하여 표시됩니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
      ...
      { type: 'head', value: '화면 및 사용성 개선' },
      {
        type: 'list',
        value:
          '관련 물품을 가로 슬라이더로 제공하며 마우스, 트랙패드, 터치 스와이프를 지원합니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '이전·다음 버튼, 카드 스냅, 스크롤 위치 표시를 추가해 여러 물품을 편리하게 살펴볼 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '모바일 반응형 화면과 라이트·다크 테마의 가독성을 개선했습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '키보드 포커스, 방향키 이동, 아이템명 Enter 이동 등 접근성을 보완했습니다.',
        class: 'text-body1'
      },
      { type: 'space' },
      { type: 'space' }
