export default {
  ...
  seo: {
    ...
    keywords:
      '디아4, 디아 4, 디아블로4, 디아블로 4, 디아, 디아블로, 거래, 거래소, 트레이드, 거래 사이트, 트레이드 사이트'
  },
  page: {
    tradeList: '거래 목록',
    itemInfo: '아이템 정보',
  ...
  filter: {
    ...
    basicDescription:
      '기본 필터 정보는 사용자 저장소에 저장됩니다. 아이템 등록 시 하드코어와 시즌 여부는 기본 필터 정보에 의해 자동으로 설정됩니다.',
    presetDescription:
      '현재 설정되어 있는 필터 값들을 저장해두는 기능입니다. 최대 5개의 프리셋을 저장할 수 있습니다.',
    affixDescription:
      '속성 검색은 최대 6개의 속성 항목을 선택할 수 있고, 5개의 속성을 선택한 경우 5개 중 조합된 4개를 포함한 아이템들도 함께 검색됩니다.',
    description: {
      advanced: "속성 필터 사용 시 '고유 속성'과 '속성'을 구분해서 사용하세요",
      advanced2:
        "간혹 판매자가 '고유 속성'과 '속성'을 잘못 입력하는 경우가 있으니 이점 고려하여 필터 하세요"
    }
  },
  sort: {
    options: [
  ...
  analyze: {
    ...
    checkCharacteristics: '아이템 고유 속성 체크',
    checkAffixes: '아이템 속성 체크',
  ...
  history: {
    ...
    yolkDrop: '{amount}개',
    description1:
      '활동 내역은 이번 달을 포함하여 최대 3개월 이전 데이터까지만 조회 가능합니다.',
    description2:
      '활동 내역 데이터 저장 이전에 등록된 아이템은 정보가 표시되지 않을 수 있으니 이점 참고하세요.',
    noData: '활동 내역이 없습니다'
  },
  notFound: {
    gotoMain: '메인 페이지로'
  ...
  maintenance: {
    ...
    contents: [
      ...
      {
        type: 'list',
        value: '이전 시즌 데이터가 비시즌(스탠)으로 이동됩니다.'
      },
      { type: 'space' },
      ...
      { type: 'image', value: '/images/notice/20231018/myspace.webp' },
      {
        type: 'list',
        value:
          '"내 공간" 페이지가 추가되며 기존 "메시지" 및 "활동 내역" 페이지가 포함됩니다.'
      },
      { type: 'space' },
      { type: 'image', value: '/images/notice/20231018/manage_block.webp' },
      {
        type: 'list',
        value: '"내 공간" 페이지에 차단 관리 페이지가 추가됩니다.'
      },
      { type: 'space' },
    ...
    bottom:
      '서버가 정상화되면 다시 공지를 통해 안내해 드리도록 하겠습니다.\n\n감사합니다.',
    close: '24시간 동안 열지 않기'
  },
  notice: {
    title: '2026년 7월 28일 업데이트',
    top: '안녕하세요, Tradurs입니다.\n거래 제안 방식과 아이템 정보 확인 및 등록 편의 기능이 개선되었습니다.',
    contents: [
      { type: 'head', value: '거래 제안 개선' },
      {
        type: 'list',
        value:
          '같은 재화로 다른 사용자의 제안이 있는 경우, 기존 최고 제안보다 높은 금액 또는 수량만 새롭게 제안할 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '금화는 금액으로 비교하며, 금화 외 물품은 같은 재화 종류와 같은 물품인 경우 수량으로 비교합니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '경쟁 조건에 맞지 않는 제안은 등록되지 않으며, 거래가 진행된 경우에도 선택되지 않은 다른 제안은 기존 상태로 유지됩니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '아이템 등록 개선' },
      {
        type: 'list',
        value:
          '아이템 등록 중 창을 닫아도 작성하던 내용을 임시 저장하여 다시 등록할 때 이어서 작성할 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '모바일 환경에서 가격 및 제안 입력 영역이 화면 너비에 맞게 표시되도록 개선했습니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '세트 아이템 정보 개선' },
      {
        type: 'list',
        value:
          '세트 아이템의 긴 세트 구성 및 효과 정보는 기본적으로 접어서 표시합니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '아이템 옵션 정보는 그대로 표시되며, 하단의 정보 보기 버튼을 눌러 세트 상세 정보를 확인할 수 있습니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '아이템 상세 페이지 관련 물품' },
      {
        type: 'list',
        value:
          '같은 판매자가 등록한 다른 판매 중 물품과 공통 속성이 3개 이상인 유사 아이템을 별도 패널에서 확인할 수 있습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '현재 물품과 동일한 일반·하드코어 및 시즌·영원의 영역에 등록된 판매 중 물품만 표시됩니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '관련 물품 패널은 마우스, 트랙패드, 터치 스와이프와 이전·다음 버튼 및 키보드 이동을 지원합니다.',
        class: 'text-body1'
      },
      { type: 'space' },
      { type: 'space' }
  ...
  support: [
    {
      ...
      answer: [
        { type: 'question', contents: '1. 현금 거래도 가능한가요?' },
        {
          type: 'answer',
          contents:
            '→ 트레이더스는 게임 내 재화를 이용한 거래만 허용되며, 현금 거래를 허용하지 않습니다.'
        },
        { type: 'question', contents: '2. 어떤 정보가 데이터에 저장되나요?' },
        {
          type: 'answer',
          contents:
            '→ 기본적으로 거래에 사용될 고유 정보인 이메일과 배틀태그, 이중으로 암호화 된 비밀번호가 저장됩니다.'
        },
        { type: 'question', contents: '3. 사이트는 안전한가요?' },
        {
          type: 'answer',
          contents:
            '→ 사이트 설계 시 단순히 거래만이 아닌 보안에도 중점을 두고 개발되었습니다.'
        },
        ...
        },
        {
          type: 'text',
          contents:
            "모질라(Mozilla)에서 제공하는 보안 체크를 'B' 등급으로 통과하였습니다."
        },
        ...
        },
        {
          type: 'text',
          contents:
            'W3C에서 제공하는 웹 표준 체크에 1건의 체크 항목만 표시됩니다.'
        }
      ]
    },
    {
      ...
      answer: [
        {
          type: 'question',
          contents:
            '1. 아이템 목록 최상단에 고정으로 나오는 아이템(박스 우측 상단 혈흔 표식)은 무엇인가요?'
        },
        {
          type: 'answer',
          contents:
            '→ 주간 어워즈 각 부문 1위 사용자들의 아이템 중 하나가 고정으로 표시됩니다.'
        },
        {
          type: 'question',
          contents: '2. 아이템 수정 및 삭제, 이미지 분석이 비 활성화입니다.'
        },
        {
          type: 'answer',
          contents:
            '→ 아이템에 제안 요청이 있는 경우입니다. 반드시 등록하실 때 항목을 꼼꼼히 확인하고 등록해 주세요.'
        },
        {
          type: 'answer',
          contents:
            '→ 철회되거나 거절된 제안만 남은 경우 아이템 수정 및 삭제, 이미지 분석이 다시 활성화됩니다.'
        },
        {
          type: 'question',
          contents:
            '3. 내가 등록한 아이템이나 제안 요청 한 아이템을 볼 수 없나요?'
        },
        {
          type: 'answer',
          contents:
            "→ 로그인한 상태에서 좌측 필터 > 나만의 검색 항목 > '내 아이템', '제안 요청 아이템' 중 원하는 필터값을 체크해서 사용하시면 됩니다."
        },
        {
          type: 'answer',
          contents:
            "→ 내 아이템'을 체크하면 서브 체크 항목인 '제안받은 아이템' 필터가 활성화되며, 내 아이템 중 제안 요청이 있는 아이템만 필터가 가능합니다."
        },
        {
          type: 'question',
          contents: '4. 거래가 무산된 경우 재 판매 설정을 할 수 있나요?'
        },
        {
          type: 'answer',
          contents:
            "→ 제안이 수락된 이후에는 거래를 취소할 수 없습니다. 상대방 과실이 있을 경우 비 매너 평가해 주시고 도움말 메뉴에 나온 '템플릿 복사' 기능을 이용해 아이템을 재등록해 주셔야 합니다."
        },
        {
          type: 'question',
          contents: '5. 비 매너 평가자에게 페널티는 없나요?'
        },
        {
          type: 'answer',
          contents:
            '→ 비 매너 평가 점수가 일정 기간 동안 기준을 초과한 경우 페널티를 줄 예정입니다.'
        },
        { type: 'question', contents: '6. 아이템 가격 제안을 없앨 수 없나요?' },
        {
          type: 'answer',
          contents:
            "→ 좌측 필터 > '가격 명시만 보기'를 체크하셔서 가격이 명시된 아이템만 보기가 가능합니다."
        },
        {
          type: 'answer',
          contents: "→ '제안받기'는 배틀태그 인증 사용자만 설정할 수 있습니다."
        },
        { type: 'question', contents: '7. 노른자는 언제 제공되나요?' },
        {
          type: 'answer',
          contents:
            '→ 새로 로그인하거나 노른자를 소모 또는 회수하는 경우(계정 정보를 체크할 시) 일일 최대 30개의 노른자가 제공됩니다. (가입 당일 x)'
        },
        {
          type: 'question',
          contents: '8. 이미지 분석 기능을 정상적으로 사용할 수 없어요.'
        },
        {
          type: 'answer',
          contents:
            '→ 계속 개선 중이긴 하나 해상도가 낮거나(사용 중인 엔진의 추천 해상도 300 DPI) 인 게임 캡처가 아닌 아이템 이미지는 인식률이 떨어집니다.'
        },
        {
          type: 'question',
          contents: '9. 아이템 상태를 구분해서 볼 수 없나요?'
        },
        {
          type: 'answer',
          contents:
            "→ 좌측 필터 > '아이템 상태' 선택 상자를 이용해 필터 가능합니다."
        },
        {
          type: 'question',
          contents: '10. 새 시즌이 시작되면 기존 거래 아이템들은 어떻게 되나요?'
        },
        {
          type: 'answer',
          contents:
            '→ 시즌이 새로 시작될 때마다 시즌 아이템은 영원의 영역(스탠더드)로 이동됩니다.'
        },
        {
          type: 'question',
          contents: '11. 아이템 상급 속성은 어떻게 지정하나요?'
        },
        {
          type: 'answer',
          contents:
            '→ 상급 속성은 아이템 인식으로 처리할 수 없어 직접 속성 추가, 수정 시 속성 좌측의 아이콘을 클릭하여 활성화하시면 됩니다.'
        },
        { type: 'question', contents: '12. 배틀 태그 인증이 어떻게 하나요?' },
        {
          type: 'answer',
          contents:
            "→ 트레이더스 정보 변경 페이지의 'BattleTag™ 변경' 항목에서 처리하면 됩니다."
        },
        {
          type: 'answer',
          contents:
            '1. 정보 변경 페이지에 지정한 배틀 태그명과 현재 로그인 되어 있거나 로그인할 배틀넷 계정이 일치하는지 확인합니다.'
        },
        {
          type: 'answer',
          contents:
            "2. 배틀 태그 입력 필드 우측에 '인증' 버튼을 클릭하여 실제 배틀넷 계정 로그인을 진행하시면 인증이 완료됩니다."
        },
        {
          type: 'answer',
          contents:
            '3. 1번에서 확인한 배틀 태그가 일치하는데도 인증이 실패하는 경우 다른 브라우저에서 인증을 진행하거나, 배틀넷 계정을 로그아웃 한 이후 다시 트레이더스 배틀 태그 인증을 진행해 주세요.'
        }
      ]
    },
    {
      ...
      answer: [
        ...
        { type: 'image', contents: '01_mobile' },
        {
          type: 'text',
          contents:
            '1.1. 모바일 환경에서는 우측 상단에 더 보기 아이콘을 클릭하시고 로그인 버튼을 클릭합니다.'
        },
        { type: 'image', contents: '02_join' },
        {
          type: 'text',
          contents:
            "2. 소셜 로그인을 이용하거나 '트레이더스가 처음이신가요?'\n링크를 클릭하여 가입 페이지로 이동합니다."
        },
        { type: 'image', contents: '03_join' },
        {
          type: 'text',
          contents:
            '3. 이메일 인증 절차가 필요하기 때문에 실제 사용하는 이메일 주소를 사용하여 가입을 진행하셔야 합니다.'
        },
        { type: 'image', contents: '04_join' },
        {
          type: 'text',
          contents:
            '4. 소셜 로그인을 통한 가입의 경우 임의 비밀번호가 자동 입력됩니다. 원하는 비밀번호를 입력해서 가입하셔도 됩니다.'
        },
        {
          type: 'text',
          contents:
            '소셜 로그인 가입 시 실제 이메일 수신이 가능한 주소인지 꼭 확인하시기 바랍니다.\n소셜 로그인을 사용하는 경우에도 최초 가입 프로세스(계정 인증 절차)는 진행하셔야 합니다.',
        ...
        { type: 'image', contents: '05_verify' },
        {
          type: 'text',
          contents:
            '5. 이메일 전송이 성공하면 이미지와 같은 알림이 표시됩니다. 인증을 24시간 내로 완료하지 않은 경우 해당 계정은 자동으로 삭제됩니다.'
        },
        { type: 'image', contents: '06_verify' },
        {
          type: 'text',
          contents:
            '6. 가입하실 때 사용하신 이메일의 메일함으로 이동하면 위와 같은 인증 메일을 확인할 수 있습니다.\n(메일이 보이지 않는 경우 스팸메일함을 확인해 보세요.)'
        },
        { type: 'image', contents: '07_verify' },
        {
          type: 'text',
          contents: '7. 계정 인증이 성공하면 이미지와 같은 알림이 표시됩니다.'
        },
        { type: 'image', contents: '08_battletag' },
        {
          type: 'text',
          contents:
            '8. 로그인 후 트레이더스 디아블로® IV 페이지로 이동하면 배틀태그 입력 화면이 나타납니다. (정상적인 사용을 위해 사용 중인 배틀태그를 입력하시면 됩니다.)'
        },
        { type: 'image', contents: '09_battletag' },
        {
          type: 'text',
          contents:
            '9.1. 사용자 정보 변경 페이지에서 배틀태그 수정이 가능합니다. (이미 인증된 배틀태그가 존재하는 경우 변경 불가)\n인증 버튼을 통해 배틀태그를 인증할 수 있습니다.'
        },
        { type: 'image', contents: '0901_battletag' },
        {
          type: 'text',
          contents:
            '9.2. 로그인 상태인 경우 사용자 툴팁에 배틀태그 인증 여부가 표시됩니다.'
        },
        { type: 'image', contents: '10_withdrawal' },
        {
          type: 'text',
          contents:
            '10. 회원 탈퇴는 사용자 정보 변경 페이지 하단에 위치하고 있으며 사용 중인 이메일 주소를 입력하면 탈퇴가 진행됩니다.'
        }
      ]
    },
    {
      ...
      answer: [
        ...
        {
          type: 'text',
          contents: '3. 아이템 티어를 선택합니다. (필수 선택값은 아닙니다)'
        },
    ...
    },
    {
      ...
      answer: [
        ...
        { type: 'image', contents: '01_make_offer' },
        {
          type: 'text',
          contents:
            "1. 구매자는 원하는 아이템을 찾아 '제안하기' 버튼을 클릭합니다."
        },
        ...
        { type: 'image', contents: '1402_evaluation' },
        {
          type: 'text',
          contents:
            '14. 이제 판매자와 구매자는 완료 버튼을 클릭해 서로의 거래에 대한 매너 평가를 남겨주시면 됩니다.\n만약 상대방이 연락이 없거나 판매 또는 구매를 하지 않는 경우에도\n\n*꼭 완료 처리를 해주셔야 노른자(yolk)가 회수되며, 미 완료 처리로 인한 페널티를 받지 않습니다.'
        },
        { type: 'image', contents: '15_evaluation' },
        {
          type: 'text',
          contents:
            '15. 서로의 완료 처리가 끝나면 상대방이 남긴 매너 평가를 확인할 수 있습니다.'
        },
        { type: 'image', contents: '16_copy' },
        {
          type: 'text',
          contents:
            "16. 거래가 무산된 경우 아이템 카드 > 아이템 명 우측 > 더보기에 있는  '템플릿 복사' 기능을 사용하여 손쉽게 아이템 재등록이 가능합니다."
        },
        { type: 'image', contents: '1701_sound' },
        {
          type: 'text',
          contents:
            '17.1. 메시지 수신 알림음을 듣고싶은 경우 브라우저(크롬) 주소창 좌측을 클릭하고,'
        },
        ...
        { type: 'image', contents: '1703_sound' },
        {
          type: 'text',
          contents:
            "17.3. '소리' 탭 값을 '허용'으로 변경하면 이제 알림음을 들을 수 있습니다."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      answer: [
        { type: 'image', contents: '01_greater' },
        {
          type: 'text',
          contents:
            '아이템 등록 또는 수정 시 속성 > 옵션 탭에 추가된 속성 중 상급 상태로 변경을 원하는 속성의 좌측 아이콘을 클릭하면,'
        },
    ...
    },
    {
      ...
      answer: [
        ...
        { type: 'text', contents: '1. 유니콘' },
        {
          type: 'text',
          contents:
            '유니콘 설정 > 화이트리스트 항목을 선택하여 tradurs.com 을 추가'
        },
        ...
        { type: 'text', contents: '2. 애드 블록' },
        {
          type: 'text',
          contents:
            '애드 블록 확장 프로그램을 사용 중인 경우 트레이더스 사이트에 접속 중일 때 애드 블록 확장 프로그램 아이콘을 클릭하여 Always로 항상 허용'
        },
        { type: 'image', contents: '03_adguard' },
        { type: 'text', contents: '3. 애드 가드' },
        {
          type: 'text',
          contents: '애드 가드 설정 > 허용 목록을 선택하여 tradurs.com을 추가'
        },
        { type: 'image', contents: '04_ublock' },
        { type: 'text', contents: '4. 유 블록' },
        {
          type: 'text',
          contents: '유 블록 설정 > 제외 목록을 선택하여 tradurs.com을 추가'
        }
      ]
    }
  ],
  awards: {
    description:
      '* 어워즈 순위는 단순히 종목 별 데이터 합산이 아닌 내부적으로 정한 기준을 바탕으로 산출됩니다',
    highPriced: {
