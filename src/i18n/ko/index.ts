export default {
  ...
  season: {
    bg: '/images/season/015/season_emblem_ko.webp',
    first: {
      socket:
  ...
  notice: {
    ...
    contents: [
      { type: 'head', value: '시즌 15 지원' },
      {
        type: 'list',
        value:
          '시즌 명칭과 엠블럼을 시즌 15: 지옥의 유산으로 변경했습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '아이템 등록 시 선택한 시즌 또는 영원 영역 설정이 올바르게 유지됩니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '기존 아이템 정보 업데이트' },
      {
        type: 'list',
        value:
      ...
      },
      {
        type: 'list',
        value:
          '복수의 수치를 가진 효과도 각 수치의 입력과 표시 순서가 유지되도록 반영했습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '황천의 팔목 장갑의 고정 접사를 주 능력치와 극대화 확률로 수정했습니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '방패 분류 변경' },
      {
        type: 'list',
        value:
          '방패를 무기에서 방어구 분류로 이동했습니다. 일반 및 고유 방패는 방어구 > 방패에서 등록하고 검색할 수 있습니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '신화 고유 직접 업그레이드 안내' },
      {
        type: 'list',
        value:
          '호라드림의 함에서 직접 업그레이드한 신화 고유는 원본 아이템의 접사와 개조를 유지하며 제작됨 태그가 붙습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '제작됨 태그가 붙은 아이템은 하나만 착용할 수 있으며, 속성 변경 불가 아이템은 직접 업그레이드에 사용할 수 없습니다.',
        class: 'text-body1'
      },
      { type: 'head', value: '신규 유산 고유 아이템' },
      {
        type: 'list',
        value:
          '레오릭의 왕관, 천벌의 팔보호구, 요르단의 반지, 꼬맹이의 블라우스, 아리옥의 바늘, 앙리의 쥐잡이, 인검, 용광로의 장비 분류와 직업 제한, 고정 접사, 고유 효과를 등록 및 검색 데이터에 추가했습니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
        value:
          '메서슈미트의 도끼는 최종 효과와 고정 접사가 확인되는 대로 추가할 예정입니다.',
        class: 'text-body1'
      },
      {
        type: 'list',
