export default {
  ...
  notice: {
    ...
    top: '안녕하세요. 트레이더스입니다.\n\n 2023.08.07 업데이트된 사항 및 유의사항 안내드립니다.',
    contents: "\n◆ 업데이트\n· 이제 제안 요청에 사용된 노른자는 제안이 채택되어 거래가 완료될 경우 모두 정상적으로 회수됩니다.\n\n◆ 유의 사항\n· 아이템 옵션이 검색되지 않아 새로 등록할 경우 수치가 입력되는 곳에 꼭 {'{'}x{'}'}를 이용하여 수치를 입력해 주시기 바랍니다. 임의로 수치를 입력한 옵션이나 잘못(배틀태그 노출, 줄임말 사용 등) 입력된 옵션은 임의로 삭제하도록 하겠습니다.\n\n",
    bottom: '감사합니다.',
    close: '24시간 동안 열지 않기'
  },
  adblock: {
