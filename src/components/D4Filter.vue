...
<template>
  <div class="column q-gutter-y-lg" :class="{ 'disable': disable }">
    <q-list class="q-gutter-sm">
      ...
      <q-item>
        <q-item-section>
          ...
          <q-option-group size="xs" :disable="filterLoading" inline class="q-pl-sm" :options="filterQuality()"
            type="checkbox" v-model="is.filter.quality" @update:model-value="update()" />
        </q-item-section>
    </q-item>
    <q-item>
      <q-item-section>
        <q-item-label header>{{ t('item.selectType') }}</q-item-label>
          <q-option-group size="xs" :disable="filterLoading" inline class="q-pl-sm" :options="filterTypes()"
            type="checkbox" v-model="is.filter.itemTypes" @update:model-value="val => update(val)" />
        </q-item-section>
      </q-item>
