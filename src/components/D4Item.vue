...
const _image = ref<number>(props.data.itemId !== '' ? props.data.imageId : Math.floor(Math.random() * itemImgs[_type.value]?.[_typeValue1.value as string]) || 0)
...
const updateTypeValue1 = (val: string) => {
  _image.value = Math.floor(Math.random() * itemImgs[_type.value]?.[_typeValue1.value as string]) || 0
