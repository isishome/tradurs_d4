...
.award {
  ...
  box-shadow: inset 0 0 0 1px rgba(50, 50, 50, 1),
    0 10px 0 1px rgba(20, 30, 30, 0.6) !important;
}

.body--light .award {
  box-shadow: inset 0 0 0 1px rgba(255, 200, 0, 1),
    0 10px 0 1px rgba(255, 200, 0, 0.6) !important;
}
...
.award::before {
  ...
  filter: invert(77%) sepia(77%) saturate(1453%) hue-rotate(360deg)
